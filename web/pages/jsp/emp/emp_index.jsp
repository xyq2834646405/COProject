						...
						<table class="table table-bordered table-hover">
							...
							<tr>
								<td rowspan="4" style="width:130px;">
									<img src="upload/user/${emp.photo}" class="image" style="height:128px;width:128px;">
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2">
									...
									<a href="pages/jsp/emp/emp/EmpUpdateActionEmp!updatePre.action" class="btn btn-warning">完善个人资料</a>
