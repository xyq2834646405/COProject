										...
										<td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a type="button" id="updateBtn-${task.tid}" href="<%=updatePreTaskUrl%>?task.tid=${task.tid}"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;修改任务</a></li>
													<c:if test="${manager.userid == project.userByMgr.userid}">
														<c:if test="${task.status!=2}">
															<li><a type="button" id="cancelBtn-${task.tid}"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;任务取消</a></li>
														</c:if>
													</c:if>
                                                </ul>
                                            </div>
