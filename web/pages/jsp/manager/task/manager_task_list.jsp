...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String insertTaskUrl = "pages/jsp/manager/task/manager_task_insert.jsp" ;
...
<script type="text/javascript" src="js/manager/manager_task_list.js"></script>
</head>
<body class="manback">
			...
			<div class="col-md-12 col-xs-12">
				<div class="panel panel-success">
					...
					<div class="panel-body">
							...
							<tbody>
								<tr>
									...
									<td class="text-center">
										...
										<a type="button" class="btn btn-warning" id="updateBtn-1" href="<%=updatePreTaskUrl%>?tid=1"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;修改任务</a>
										<button type="button" class="btn btn-danger" id="cancelBtn-1"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;任务取消</button>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<div>
							<a href="<%=insertTaskUrl%>" class="btn btn-primary btn-lg">增加新任务</a>
						</div>
