							...
							<tbody>
								<tr>
									...
									<td class="text-center">
										<a type="button" class="btn btn-primary" href="pages/jsp/manager/task/manager_task_insert.jsp?proid=1">创建任务</a>
										<a type="button" class="btn btn-warning" href="pages/jsp/manager/task/manager_task_list.jsp?proid=1">任务管理</a>
									</td>
								</tr>
							</tbody>
						</table>
