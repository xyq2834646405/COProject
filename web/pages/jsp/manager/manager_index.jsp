						...
						<table class="table table-bordered table-hover">
							<tr>
								<td colspan="3">
									...
									<strong><span class="glyphicon glyphicon-envelope"></span>&nbsp;未读公告（<span class="text-danger">
										<a href="pages/jsp/manager/notice/NoticeActionManager!list.action" id="noticeCount"></a>
									</span>）</strong>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2">
									...
									<a href="pages/jsp/manager/manager/ManagerUpdateActionManager!updatePre.action" class="btn btn-warning">完善个人资料</a>
