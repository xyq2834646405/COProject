...
<script type="text/javascript" src="js/admin/admin_notice_insert.js"></script>
</head>
<body class="back">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<%=insertUrl%>" id="myform" method="post">
							<fieldset>
								<!-- 定义表单提示框 -->
								<legend>
									<label><span class="glyphicon glyphicon-file"></span>&nbsp;发布系统公告</label>
								</legend>
								...
								<div class="form-group" id="notice.levelDiv">
									...
									<!-- 定义表单错误提示显示元素 -->
									<div class="col-md-4" id="notice.levelMsg"></div>
								</div>
