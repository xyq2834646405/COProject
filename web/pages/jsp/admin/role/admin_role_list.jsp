								...
								<c:if test="${allRoles != null}">
									<c:forEach items="${allRoles}" var="role">
										<tr>
											...
											<td class="text-center"><span id="title-${role.rid}">${role.title}</span></td>
											<td class="text-center"><span id="note-${role.rid}">${role.note}</span></td>
											<td class="text-center">
												<button class="btn btn-primary" id="updateBtn-${role.rid}"><span class="glyphicon glyphicon-edit"></span>&nbsp;修改</button>
											</td>
										</tr>
									</c:forEach>
								</c:if>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="modal-title">
							...
							<strong>修改“<span id="roleTitleSpan"></span>”信息</strong></h3>
					</div>
						...
						<form class="form-horizontal" action="" id="myform" method="post">
							<fieldset>
								...
								<div class="form-group" id="gidDiv">
									...
									<div class="col-md-5" id="groupsDiv">
								...
								<div class="form-group">
									<div class="col-md-5 col-md-offset-3">
										<input type="hidden" id="role.rid" name="role.rid">
