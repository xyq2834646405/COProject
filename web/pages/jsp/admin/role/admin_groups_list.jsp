							...
							<tbody>
								<c:if test="${allGroups != null}">
									<c:forEach items="${allGroups}" var="gup">
										<tr>
											<td class="text-center">${gup.gid}</td>
											<td class="text-center">
												<input type="text" id="title-${gup.gid}" name="title-${gup.gid}" class="form-control input-sm" value="${gup.title}">
											</td>
											<td class="text-center">
												<input type="text" id="note-${gup.gid}" name="note-${gup.gid}" class="form-control input-sm" value="${gup.note}">
											</td>
											<td class="text-center">
												<button class="btn btn-primary" id="updateBtn-${gup.gid}"><span class="glyphicon glyphicon-edit"></span>&nbsp;修改</button>
												<button class="btn btn-info" id="showBtn-${gup.gid}"><span class="glyphicon glyphicon-list"></span>&nbsp;包含权限</button>
											</td>
										</tr>
									</c:forEach>
								</c:if>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="modal-title">
							...
							<strong>查看“<span id="groupsTitleSpan"></span>”信息</strong></h3>
					</div>
