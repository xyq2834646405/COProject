...
<head>
	...
	<script type="text/javascript" src="js/admin/admin_task_list.js"></script>
</head>
<body class="back">
					...
					<table class="table table-condensed">
						...
						<c:forEach items="${allTasks}" var="task">
							<tr>
								...
								<td class="text-center"><a href="<%=showUrl%>?user.userid=${task.userByCreator.userid}" class="btn btn-info">${task.userByCreator.userid}</a></td>
								<td class="text-center"><a href="<%=showUrl%>?user.userid=${task.userByReceiver.userid}" class="btn btn-info">${task.userByReceiver.userid}</a></td>
