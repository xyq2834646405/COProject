...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String deleteUrl = basePath + "pages/jsp/admin/document/DocumentActionAdmin!delete.action" ;
...
<script type="text/javascript" src="js/admin/common_document_admin.js"></script>
</head>
<body class="back">
