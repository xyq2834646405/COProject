...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String insertUrl = basePath + "pages/jsp/admin/admin/AdminActionAdmin!insert.action" ;
%>
...
<script type="text/javascript" src="js/admin/admin_admin_insert.js"></script>
</head>
<body class="back">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<%=insertUrl%>" id="myform" method="post">
							<fieldset>
								<!-- 定义表单提示框 -->
								<legend>
									<label><span class="glyphicon glyphicon-user"></span>&nbsp;增加系统管理员</label>
								</legend>
								...
								<div class="form-group" id="role.ridDiv">
									<!-- 定义表单提示文字 -->
									<label class="col-md-3 control-label" for="role.rid">具备角色：</label>
									<div class="col-md-5">
										<select id="role.rid" name="role.rid" class="form-control">
											<option value="">==== 请选择管理员具备的角色 ====</option>
									...
									<!-- 定义表单错误提示显示元素 -->
									<div class="col-md-4" id="role.ridMsg"></div>
								</div>
